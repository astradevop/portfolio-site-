    ...
    <article className="group relative glass rounded-2xl p-6 shadow-xl hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-300 overflow-hidden transform hover:scale-105 cursor-pointer">
      ...
      <div className="relative z-10">
        ...
        <div className="mt-6 pt-4 border-t border-white/10">
          <div className={`flex ${project.liveLink ? 'gap-3' : ''}`}>
            <a 
              href={project.githubLink} 
              target="_blank" 
              rel="noopener noreferrer"
              className={`inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-teal-400 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-pink-500/50 transform hover:scale-105 transition-all duration-200 justify-center group ${project.liveLink ? 'flex-1' : 'w-full'}`}
            ...
            >
              ...
              {project.liveLink ? 'GitHub' : 'View on GitHub'}
            </a>
            {project.liveLink && (
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-400 to-pink-500 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-teal-500/50 transform hover:scale-105 transition-all duration-200 flex-1 justify-center group"
